...
class FileNamingBase(object):
    ...
    def test_basic(self):
        ...
        log.Info("Inc filename: " + util.fsdecode(filename))
        ...
        log.Info("Full sig filename: " + util.fsdecode(filename))
        pr = file_naming.parse(filename)
...
class FileNamingLong(UnitTestCase, FileNamingBase):
    ...
    def setUp(self):
        ...
        self.set_config('short_filenames', 0)
...
class FileNamingShort(UnitTestCase, FileNamingBase):
    ...
    def setUp(self):
        ...
        self.set_config('short_filenames', 1)
