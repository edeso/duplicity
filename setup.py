...
try:
    ...
    Version = "0.8.24.dev"
    print("Unable to get SCM version: defaulting to %s" % (Version,))
...
class SdistCommand(sdist):
    ...
    def run(self):
        ...
        tarfile = "%s/duplicity-%s.tar.gz" % (self.dist_dir, Version)
        ...
        assert not os.chmod(os.path.join(tardir, "bin", "rdiffdir"), 0o755)
